// convert from yen/euros/pounds/francs to dollars
// a suffix 'y', 'e', 'p', or 'f' indicates the currency of the input
import std;
using namespace std;
...
int main() {
  ...
  constexpr double francs_dollar_rate = 1.2098413;

  double amount = 0;
  char currency = ' ';
  cout << "Please enter any amount of money followed by the currency (y/e/p/f):\n"
       << "y=yen, e=euro, p=pound f=francs\n";
  cin >> amount >> currency;
  ...
  switch (currency) {
    ...
    case 'p':
      ...
      break;
    case 'f':
      cout << "CHF" << amount << " == $" << amount*francs_dollar_rate << '\n';
      break;
    default:
